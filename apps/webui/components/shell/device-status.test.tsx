...
describe("DeviceStatus", () => {
  it("renders idle state", () => {
    ...
    expect(el.querySelector(".bg-zinc-400")).toBeTruthy();
  });
  ...
  it("renders connecting state with amber dot", () => {
    ...
    expect(el.querySelector(".bg-amber-500")).toBeTruthy();
  });
  ...
  it("renders connected state with display name", () => {
    ...
    expect(el.querySelector(".bg-emerald-500")).toBeTruthy();
  });
  ...
  it("renders disconnected state", () => {
    ...
    expect(el.querySelector(".bg-zinc-500")).toBeTruthy();
  });
  ...
  it("renders error state with reason and message", () => {
    ...
    expect(el.querySelector(".bg-red-500")).toBeTruthy();
  });
});
