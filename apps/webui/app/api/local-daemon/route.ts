...
export async function GET(): Promise<Response> {
  ...
  const launchIntent = parsed.launchIntent === "attached" || parsed.launchIntent === "user_started" ? parsed.launchIntent : undefined;
  if (!wsUrl || !token || !host || port === undefined || !launchIntent) {
