...
const api: GuiApi = {
  ...
  getRuntimeSettings: (project) => ipcRenderer.invoke(guiIpcChannels.getRuntimeSettings, project),
  upsertRuntimeSettings: (project, input) => ipcRenderer.invoke(guiIpcChannels.upsertRuntimeSettings, project, input),
